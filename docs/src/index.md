...
The simulator can be run either directly or imported as package.  

When run directly, all parameters are read from yaml files at the [your_repo_root]/macaqueretina/parameters folder. 
