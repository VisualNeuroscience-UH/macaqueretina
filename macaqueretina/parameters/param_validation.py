...
class StimulusGeneratorParameters(BaseConfigModel):
    pattern: str = Field(
        ...
        description="Options: 'sine_grating', 'square_grating', 'colored_temporal_noise', 'white_gaussian_noise', 'natural_images', 'iterating_natural_images', 'natural_video', 'temporal_sine_pattern', 'temporal_square_pattern', 'temporal_chirp_pattern', 'contrast_chirp_pattern', 'spatially_uniform_binary_noise'",
    )
...
class RetinaParametersExtend(BaseConfigModel):
    ...
    class Visual2CorticalParameters(BaseConfigModel):
        a: float = 0.077 / 0.082  # ~0.94
        k: float = 1 / 0.082  # ~12.2

    visual2cortical_params: Visual2CorticalParameters
