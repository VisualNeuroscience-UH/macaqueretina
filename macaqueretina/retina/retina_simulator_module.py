...
class TemporalModelSubunit(TemporalModelBase):
    ...
    def impulse_response(
        ...
        duration_tp = 1
        options = self.stimulus_factory.options
        ...
        for idx, contrast in enumerate(contrasts):
            ...
            self.stimulus_factory.options = options
            vs.stimulus_video = self.stimulus_factory.generate(options=options)
...
class ConcreteSimulationBuilder(SimulationBuildInterface):
    ...
    def __init__(
        ...
        self._stimulus_factory = stimulus_factory
    ...
    @property
    def stimulus_factory(self):
        return self._stimulus_factory
...
class VisualSignal(PrintableMixin):
    ...
    def __init__(
        ...
        pix_per_deg: float,
        stimulus_video: StimulusFactory | None = None,
    ):
...
class RetinaSimulator:
    ...
    @property
    def stimulus_factory(self) -> StimulusFactory:
        return self._stimulus_factory
    ...
    def _get_project_data_for_viz(
        ...
        self.project_data.retina_simulator["stim_to_show"] = stim_to_show
        self.project_data.retina_simulator["gc_responses_to_show"] = (
            gc_responses_to_show
        )
        self.project_data.retina_simulator["photodiode_to_show"] = photodiode_to_show
        ...
        if gcs.temporal_model_type == "fixed":
            ...
            self.project_data.retina_simulator["spat_temp_filter_to_show"] = (
                spat_temp_filter_to_show
            )
        ...
        self.project_data.retina_simulator["cone_responses_to_show"] = (
            cone_responses_to_show
        )
    ...
    def _get_products(
        ...
        Parameters
        ----------
        stimulus : StimulusFactory or None
    ...
    def simulate(
        ...
        self.project_data.retina_simulator.update(builder.project_data)
