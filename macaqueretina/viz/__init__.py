...
def __getattr__(name):
    ...
    if current_config is None:
        raise AttributeError(f"Cannot access attribute '{name}' without configuration. Run mr.load_parameters() first.")
...
def __dir__():
    ...
    if current_config is None:
        print("Configuration not found. Run mr.load_parameters() before accessing mr.viz.")
        return []
